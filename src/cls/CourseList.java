...
public class CourseList {
	...
	public void printProfessorNameAndRoom() {
		for(int i=0; i<idx; i++) {
			Professor professor = this.courseArray[i].getPreofessor();
	...
	public void printProfessor() {
		for(int i=0; i<idx; i++) {
			Professor professor = this.courseArray[i].getPreofessor(); //교수를 불러온다
	...
	public void SelectCredit(int crd) {
